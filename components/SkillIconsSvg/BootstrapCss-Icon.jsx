...
function Icon() {
  return (
    <div  className="group block">
      ...
      <p className="absolute lg:top-[21.5rem] lg:left-[39rem] md:top-[12rem] md:left-[11.7rem] top-[11rem] left-[9rem]  font-semibold text-black text-2xl z-0 opacity-0 group-hover:opacity-100">
          BootstrapCSS
      </p>
    </div>
  );
